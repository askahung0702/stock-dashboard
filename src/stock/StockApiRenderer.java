...
public class StockApiRenderer {
    ...
    private JSONObject rowToJson(SnapshotRow row) {
        ...
        obj.put("marginBalanceDelta",              Long.valueOf(row.marginBalanceDelta));
        obj.put("marginBuy",                       Long.valueOf(row.marginBuy));
        obj.put("marginSell",                      Long.valueOf(row.marginSell));
        obj.put("marginCashRepay",                 Long.valueOf(row.marginCashRepay));
        obj.put("marginLimit",                     Long.valueOf(row.marginLimit));
        obj.put("marginUsagePct",                  Double.valueOf(row.marginUsagePct));
        obj.put("previousShortBalance",            Long.valueOf(row.previousShortBalance));
        obj.put("shortBalance",                    Long.valueOf(row.shortBalance));
        obj.put("shortBalanceDelta",               Long.valueOf(row.shortBalanceDelta));
        obj.put("shortMarginRatioPct",             Double.valueOf(row.shortMarginRatioPct));
        obj.put("shortUsagePct",                   Double.valueOf(row.shortUsagePct));
        obj.put("marginTradingNote",               row.marginTradingNote);
