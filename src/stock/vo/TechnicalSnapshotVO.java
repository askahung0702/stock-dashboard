...
public class TechnicalSnapshotVO {
    ...
    public TechnicalSnapshotVO(double currentPrice, double movingAverage20, double movingAverage60,
            double movingAverage120, double return20DayPct, double return60DayPct, long currentVolume,
